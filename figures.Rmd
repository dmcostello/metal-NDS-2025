...
plot(INORGNWETDEP2008WS~SRP_ugL,data=predclass,log="x",col=c("orangered","black")[Fe_TF],xlim=c(1,100),ylim=c(2,8),las=1,pch=c(16,1)[Fe_TF],
...
plot(PDP_P$y~PDP_P$x,type="l",log="x",xlim=c(1,100),xaxt="n",las=1,
     xlab="",ylim=c(-0.4,0.2),ylab="logit(Fe)",cex.lab=1.2)
text(1,0.85,"b",cex=2)
...
plot(PDP_Ndep$x~PDP_Ndep$y,type="l",ylim=c(2,8),yaxt="n",las=1,
     ylab="",xlim=c(-0.5,0.4),xlab="logit(Fe)",cex.lab=1.2)
text(-0.4,8,"c",cex=2)
text(-0.1,c(3.12,2.88),c("Probable","Fe limitation"),col="orangered")
axis(2,labels=F)
abline(h=3.55,lty=2)
